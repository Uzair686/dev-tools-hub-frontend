...
const TONES = [
  ...
  { label: "Simple", value: "simple and easy to understand", emoji: "✨" },
    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-500 dark:text-slate-400">
          Rewrite any text using AI to improve tone, clarity and style.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <textarea
            ...
            placeholder="Paste your text here and AI will rewrite it..."
            className="w-full h-64 p-4 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-900 dark:text-white text-sm resize-none focus:outline-none focus:border-blue-500 transition-colors"
          />
        ...
        <div className="flex flex-col gap-3">
          ...
          {output && (
            <div className="text-xs text-green-600 dark:text-green-400 font-medium">
              ✅ Rewritten in {tone} tone — {output.length} characters
            </div>
          )}
        </div>
      </div>
